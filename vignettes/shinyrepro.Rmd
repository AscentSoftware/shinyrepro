...
There is a single exported function, `repro`, that takes a reactive object and converts it into a 
...
This is general best-practice when developing Shiny applications, but avoid putting code for its side effects
in `reactive` expressions, and instead create smaller reactive calls, and have observers running the code
not intended for reproducing outputs.
